...
N2_CornerHarrisPoints.corner_harris_points(surface_name, test_or_not=False)

# extract the nodes relationship
N4_NodesRelationship.nodes_relationship(surface_name)
...
N5_ResultVisualization.result_visualize(surface_name)
